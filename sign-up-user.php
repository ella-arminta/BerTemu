            ...
            <div class="row d-flex justify-content-center">
                ...
                <form method="post" style="width: 100%;">
                    ...
                    <div class="mb-3 uploadFoto">
                        ...
                        <input type="file" accept=".jpg, .jpeg, .png, .jfif" class="form-control hidden" multiple="false" name="submitFotoKTP" id="submitFotoKTP" onchange="read_file(this)" value="assets/no-image.png">
                        <button type="button" class="btn deleteFoto">Delete</button>
                    </div>
                </form>
            </div>
        </div>
